...
class ProviderMakeCommand extends GeneratorCommand
{
    ...
    protected function getOptions()
    {
        return [
            ...
            ['permission', null, InputOption::VALUE_NONE, 'Indicates the permission service provider', null],
        ];
    }
    ...
    protected function getTemplateContents()
    {
        ...
        $stub = $this->option('event') ? 'provider-event' : $stub;
        ...
        return (new Stub('/' . $stub . '.stub', [
            ...
            'EVENT_LISTENERS' => $this->option('permission') ? $this->getPermissions() : ' '
        ]))->render();
    }
    ...
    {
        return "GetAppPermissions::class => [
            \Labs\\" . $this->getModuleName() . "\Listeners\GetAppPermissionsListener::class,
        ],";
    }
}
