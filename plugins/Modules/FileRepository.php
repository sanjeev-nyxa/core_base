...
use Labs\Modules\Exceptions\InvalidAssetPath;
use Labs\Modules\Exceptions\ModuleNotFoundException;
use Labs\Modules\Process\Installer;
use Labs\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \Labs\Modules\Exceptions\ModuleNotFoundException
     */
